...
function PageLoading() {
  return (
    <div style={{ padding: '1rem' }}>
      <div className="skeleton" style={{ width: '50%', height: 22, marginBottom: '0.75rem' }}>&nbsp;</div>
      <div className="skeleton" style={{ width: '100%', height: 180, borderRadius: 'var(--radius-md)' }}>&nbsp;</div>
    </div>
  );
}

        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', gap: '0.375rem', alignItems: 'center', marginLeft: 'auto' }}>
            <input
              type="date"
              className="input"
              style={{ width: 140, fontSize: '0.75rem', padding: '0.35rem 0.5rem' }}
              value={customStart}
      ...
      {loading ? (
        ...
        <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
                ...
                <tr className="total-row">
                  ...
                  <td className="num" style={{ color: 'var(--color-text-muted)' }}>
                    {profitData.totalRevenue > 0
                      ? `${Math.round((profitData.grossProfit / profitData.totalRevenue) * 1000) / 10}%`
                      : '—'}
                  </td>
          ...
          <div className="profit-net-strip">
            ...
            <div className="profit-net-op profit-net-op-eq">
              <span>=</span>
            </div>
            <div className={`profit-net-item profit-net-final ${profitData.netProfit >= 0 ? 'profit-positive' : 'profit-negative'}`}>
              ...
              <span className="profit-net-amount" style={{ fontWeight: 800, fontSize: '1.125rem' }}>

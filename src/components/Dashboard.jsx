...
export default function Dashboard() {
  ...
  // Cut = 10% of NET INCOME (viewRevenue − viewCOGS). No expense deduction.
  // Money set aside out of profit, so netProfit = netIncome − cut.
  const netIncome = viewRevenue - viewCOGS;
